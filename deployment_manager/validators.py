...
class SystemValidator:
    ...
    def _add_result(self, name: str, level: ValidationLevel, passed: bool, 
    ...
    def check_admin_privileges(self):
        ...
        try:
            ...
            self._add_result(
                ...
                is_admin,
                "Running with admin rights" if is_admin else "Not running as administrator",
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                self._add_result(
                    ...
                    "Install Node.js 18+ from https://nodejs.org/" if not passed else ""
                )
            else:
            ...
            if result.returncode == 0:
                ...
                if match:
                    ...
                    self._add_result(
                        ...
                        passed,
                        f"Version {version} detected",
                        "Install PHP 8.2+ from https://windows.php.net/" if not passed else ""
                    )
                else:
            ...
            if result.returncode == 0:
                ...
                if match:
                    ...
                    self._add_result(
                        ...
                        passed,
                        f"Version {version} detected",
                        "Install Composer 2+ from https://getcomposer.org/" if not passed else ""
                    )
                else:
                    self._add_result(
                        "Composer",
    ...
    def check_config_file(self):
        ...
        self._add_result(
            ...
            ValidationLevel.CRITICAL,
            exists,
            "deployment.config.env found" if exists else "deployment.config.env missing",
    ...
    def check_php_extensions(self):
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                message = "All required extensions present" if passed else f"Missing: {', '.join(missing)}"
